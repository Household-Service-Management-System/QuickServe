...
const bannerImages = [
  ...
  "https://images.pexels.com/photos/5591843/pexels-photo-5591843.jpeg",
  "https://images.pexels.com/photos/5691503/pexels-photo-5691503.jpeg",
  "https://images.pexels.com/photos/4491919/pexels-photo-4491919.jpeg",
];
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center px-4">
                <div className="max-w-5xl mx-auto text-center md:text-left">
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                    className="inline-flex px-3 py-1 rounded-full bg-white/80 text-xs md:text-sm font-semibold text-blue-900 mb-4"
                  >
                    Trusted Home Services • On-Demand
                  </motion.div>
                  ...
                  >
                    Book Trusted{" "}
                    <span className="text-blue-300">Home Services</span> in Minutes
                  </motion.h1>
                  ...
                  <TypeAnimation
                    ...
                    wrapper="h2"
                    className="text-lg md:text-2xl text-blue-200 mb-6"
                    repeat={Infinity}
                  />
